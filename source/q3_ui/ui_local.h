...
extern vmCvar_t	Inv_Conf_MarineWeapon;
extern vmCvar_t	Inv_Conf_MarineArmor;
extern vmCvar_t	Inv_Conf_AlienRace;
...
extern vmCvar_t	ui_inv_winlimit;
extern vmCvar_t	ui_inv_timelimit;
extern vmCvar_t	ui_inv_friendly;
extern vmCvar_t	ui_inv_RoundTime;
extern vmCvar_t	ui_inv_SwapPeriod;
...
extern void UI_ConfirmMenu(const char *question, void (*draw)(void), void (*action)(qboolean result), qboolean Error);
...
// ui_team.c
//
extern void UI_TeamMainMenu(int NbRed, int NbBlue);
...
extern void Inv_UI_MarineSelection_f();
extern void Inv_UI_AlienSelection_f();
