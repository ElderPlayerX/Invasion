...
static void Preferences_SetMenuItems(void)
{
	...
	s_preferences.IGH.curvalue		 			= trap_Cvar_VariableValue("inv_cg_DrawInGameHelp") != 0;
...
static void Preferences_Event(void* ptr, int notification)
{
	...
	case ID_IGH:
		trap_Cvar_SetValue("inv_cg_DrawInGameHelp", s_preferences.IGH.curvalue);
		break;
...
static void Preferences_MenuInit(void)
{
	...
	s_preferences.DrawTimer.generic.x			= PREFERENCES_X_POS;
	s_preferences.DrawTimer.generic.y			= y;

	y += BIGCHAR_HEIGHT+2;
	s_preferences.IGH.generic.type		= MTYPE_RADIOBUTTON;
	s_preferences.IGH.generic.name		= "InGame Help:";
	s_preferences.IGH.generic.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.IGH.generic.callback	= Preferences_Event;
	s_preferences.IGH.generic.id       = ID_IGH;
	s_preferences.IGH.generic.x	      = PREFERENCES_X_POS;
	s_preferences.IGH.generic.y	      = y;
	...
	Menu_AddItem(&s_preferences.menu, &s_preferences.IGH);
