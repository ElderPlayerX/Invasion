...
void Main_MenuEvent (void* ptr, int event)
{
	...
	case ID_EXIT:
		UI_ConfirmMenu("EXIT GAME?", NULL, MainMenu_ExitAction, qfalse);
		break;
	}
}
...
static void Main_MenuDraw(void)
{
	...
	{
		vec4_t color2 = {0.3f, 0.6f, 1.0f, 1.0f};
		UI_DrawProportionalString(320, 420, "Beta "INVASION_VERSION, UI_CENTER|UI_SMALLFONT, color2);
