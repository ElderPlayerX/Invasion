...
//Too: Invasion Binds
#define ID_DROPGUN		34
#define ID_SELECTGUN		35
#define ID_ATTACK2		36
#define ID_RELOAD			37
#define ID_NIGHTVISION	38
...
typedef struct
{
	...
	menuaction_s		DropGun;
	menuaction_s		SelectGun;
	menuaction_s		attack2;
	menuaction_s		reload;
	menuaction_s		NightVision;
...
static bind_t g_bindings[] =
{
	...
	{"weapon 1",		"crowbar",				ID_WEAPON1,		ANIM_WEAPON1,	'1',			-1,		-1, -1},
	...
	{"Inv_DropMainGun","Drop Main Gun",		ID_DROPGUN,		ANIM_IDLE,	K_BACKSPACE,			-1,		-1, -1},
	{"Inv_SMG",			"Main Gun",				ID_SELECTGUN,	ANIM_WEAPON3,	'3',			-1,		-1, -1},
	{"+button5", 		"2nd Attack",			ID_ATTACK2,		ANIM_ATTACK,	K_MOUSE2,			-1,		-1, -1},
	{"+button6", 		"Reload",				ID_RELOAD,		ANIM_IDLE,		K_KP_MINUS,			-1,		-1, -1},
	{"Inv_NV",			"Night Vision",		ID_NIGHTVISION,ANIM_IDLE,		'4',			-1,		-1, -1},
...
static menucommon_s *g_weapons_controls[] =
{
	...
	(menucommon_s *)&s_controls.SelectGun,
	(menucommon_s *)&s_controls.DropGun,
	NULL,
};
...
{
	(menucommon_s *)&s_controls.NightVision,
...
static void Controls_MenuEvent(void* ptr, int event)
{
	switch (((menucommon_s*)ptr)->id)
	{
		...
		case ID_DEFAULTS:
			if (event == QM_ACTIVATED)
			{
				UI_ConfirmMenu("SET TO DEFAULTS?", Controls_ResetDefaults_Draw, Controls_ResetDefaults_Action, qfalse);
			}
			break;
...
static void Controls_MenuInit(void)
{
	...
	s_controls.DropGun.generic.type	    = MTYPE_ACTION;
	s_controls.DropGun.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.DropGun.generic.callback  = Controls_ActionEvent;
	s_controls.DropGun.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.DropGun.generic.id        = ID_DROPGUN;

	s_controls.SelectGun.generic.type	    = MTYPE_ACTION;
	s_controls.SelectGun.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.SelectGun.generic.callback  = Controls_ActionEvent;
	s_controls.SelectGun.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.SelectGun.generic.id        = ID_SELECTGUN;
	...
	s_controls.NightVision.generic.type	    = MTYPE_ACTION;
	s_controls.NightVision.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.NightVision.generic.callback  = Controls_ActionEvent;
	s_controls.NightVision.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.NightVision.generic.id        = ID_NIGHTVISION;
	...
	Menu_AddItem(&s_controls.menu, &s_controls.SelectGun);
	Menu_AddItem(&s_controls.menu, &s_controls.DropGun);

	Menu_AddItem(&s_controls.menu, &s_controls.NightVision);
