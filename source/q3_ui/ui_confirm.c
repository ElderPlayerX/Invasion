...
static void ConfirmMenu_Draw(void)
{
	...
	UI_DrawProportionalString(320, 204, s_confirm.question, Type, color_red);
...
=================
*/
void UI_ConfirmMenu(const char *question, void (*draw)(void), void (*action)(qboolean result), qboolean Error)
{
	...
	s_confirm.Error = Error;

	if (Error)
		l1 = 320 - (UI_ProportionalStringWidth("OK") / 2);
	else
	{
