...
weaponInfo_t		cg_weapons[MAX_WEAPONS + 1];
...
vmCvar_t	Inv_cg_drawCrosshairSpectator;
vmCvar_t Inv_cg_PrecacheAllModels;
vmCvar_t	Inv_cg_DrawInGameHelp;
...
static cvarTable_t cvarTable[] =
{
	...
	{ &Inv_cg_drawCrosshairSpectator, "Inv_cg_drawCrosshairSpectator", "1", CVAR_ARCHIVE },
	{ &Inv_cg_PrecacheAllModels, "Inv_cg_PrecacheAllModels", "1", CVAR_ARCHIVE },
	{ &Inv_cg_DrawInGameHelp, "Inv_cg_DrawInGameHelp", "1", CVAR_ARCHIVE },
...
void QDECL CG_Error(const char *msg, ...)
{
	...
	trap_SendConsoleCommand(va("Inv_ui_Error %s ", text));
...
static void CG_RegisterSounds(void)
{
	...
	if (cgs.gametype >= GT_TEAM || cg_buildScript.integer)
	{
		...
		if (cgs.gametype == GT_DESTROY || cg_buildScript.integer)
		{
			cgs.media.sfx_DeconAlien = trap_S_RegisterSound("sound/feedback/DeconAlien.wav", qtrue);
			cgs.media.sfx_DeconMarine = trap_S_RegisterSound("sound/feedback/DeconMarine.wav", qtrue);
		}
...
//		}
	...
	cgs.media.sfx_WeaponReload = trap_S_RegisterSound("sound/weapons/Reload.wav", qfalse);
	cgs.media.sfx_LaunchGrenade = trap_S_RegisterSound("sound/weapons/Grenades/Launch.wav", qfalse);
	cgs.media.sfx_VisionSwap = trap_S_RegisterSound("sound/feedback/VisionSwap.wav", qfalse);
}
...
static void CG_RegisterGraphics(void)
{
...
#endif
	cgs.media.plasmaBallShader = trap_R_RegisterShader("sprites/plasmaAcid");
	cgs.media.FlameShader = trap_R_RegisterShader("flamethrower/FireFlame");
	...
	cgs.media.energyMarkShader = trap_R_RegisterShader("gfx/damage/acid_mrk");//plasma_mrk");
	...
	//Too: Register Invasion specific stuff
	cgs.media.grenadeExplosionShader = trap_R_RegisterShader("BloomyExplosion");
	cgs.media.Radiation = trap_R_RegisterShaderNoMip("invasion/icon/Radiation");
	cgs.media.MagneticShader = trap_R_RegisterShader("powerups/magnetic");
	cgs.media.InvGoal = trap_R_RegisterShaderNoMip("invasion/icon/InvGoal");
	cgs.media.InvGoalUp = trap_R_RegisterShaderNoMip("invasion/icon/InvGoalUp");
	cgs.media.InvGoalDown = trap_R_RegisterShaderNoMip("invasion/icon/InvGoalDown");
	cgs.media.InvRadarDot = trap_R_RegisterShaderNoMip("invasion/icon/InvRadarDot");
	cgs.media.InvRadarDotUp = trap_R_RegisterShaderNoMip("invasion/icon/InvRadarDotUp");
	cgs.media.InvRadarDotDown = trap_R_RegisterShaderNoMip("invasion/icon/InvRadarDotDown");
	cgs.media.InvRadar = trap_R_RegisterShaderNoMip("invasion/icon/InvRadar");
	cgs.media.tracerShader = trap_R_RegisterShader("invasion/tracer");
	cgs.media.ZoomBlack = trap_R_RegisterShader("Invasion/ZoomBlack");
	cgs.media.NightVision[0] = trap_R_RegisterShader("Invasion/LightAmplifier");
	cgs.media.NightVision[1] = trap_R_RegisterShader("Invasion/NightVision");
	cgs.media.NightVision[2] = trap_R_RegisterShader("Invasion/NightVisionLA");
	cgs.media.VisionSwapFx = trap_R_RegisterShader("Invasion/VisionSwapFx");
	cgs.media.NightVisionCloak[0] = trap_R_RegisterShader("Invasion/NightVisionCloak");
	cgs.media.NightVisionCloak[1] = trap_R_RegisterShader("Invasion/NightVisionCloakAlien");
	cgs.media.NightVisionCloak[2] = trap_R_RegisterShader("Invasion/NightVisionCloakVisor");
	cgs.media.AcidMark = trap_R_RegisterShader("Invasion/AcidMark");
	cgs.media.AcidTrail = trap_R_RegisterShader("Invasion/AcidTrail");
	cgs.media.AcidExplosion = trap_R_RegisterShader("Invasion/AcidExplosion");
	cgs.media.RadBloodMark = trap_R_RegisterShader("Invasion/RadBloodMark");
	cgs.media.RadBloodTrail = trap_R_RegisterShader("Invasion/RadBloodTrail");
	cgs.media.LowArmor = trap_R_RegisterShader("Invasion/LowArmor");
	cgs.media.EggZone = trap_R_RegisterShader("Invasion/EggZone");
...
static void CG_RegisterClients(void)
{
	...
	clientInfo = CG_ConfigString(CS_PLAYERS+cg.clientNum);

	CG_LoadingClient(cg.clientNum);
	CG_NewClientInfo(cg.clientNum, clientInfo);
...
void CG_Init(int serverMessageNum, int serverCommandSequence, int clientNum)
{
	...
	if (Inv_cg_PrecacheAllModels.integer == 1)
	{
