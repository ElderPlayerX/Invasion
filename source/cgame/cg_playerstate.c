...
void CG_CheckAmmo(void)
{
	...
	if (cg.snap->ps.persistant[PERS_TEAM] == cgs.InvasionInfo.AlienTeam)
	{
		...
		if (Race == e_Selection_Bloomy || Race == e_Selection_Rad)
		{
			cg.lowAmmoWarning = 0;
			return;
		}
...
void CG_CheckLocalSounds(playerState_t *ps, playerState_t *ops)
{
	...
	int MinHealth = 2;// 1;	//Too: Aliens life decrease at 2 point/s
	sfxHandle_t sfx;
	...
	if (ps->stats[STAT_HEALTH] < ops->stats[STAT_HEALTH] - MinHealth)
	{
