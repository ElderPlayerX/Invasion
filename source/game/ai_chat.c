...
char *BotWeaponNameForMeansOfDeath(int mod)
{
	switch (mod)
	{
		...
		case MOD_PLASMA: case MOD_PLASMA_SPLASH:
			return "Plasmagun";
		case MOD_FLAME: case MOD_FLAME_SPLASH:
			return "FlameThrower";
		case MOD_RAILGUN:
			return "Railgun";
		case MOD_LIGHTNING:
			return "Lightning Gun";
		case MOD_BFG: case MOD_BFG_SPLASH:
			return "BFG10K";
#ifdef MISSIONPACK
		...
		case MOD_GRAPPLE:
			return "Grapple";
		case MOD_BLOOMY: case MOD_BLOOMY_SPLASH:
			return "Bloomy Explosion";
		case MOD_RADIATION:
			return "Rad power";
		default:
...
#else
		case 8: return "Chaingun";
		case 9: return "FlameThrower";
#endif
