...
//Too: Frag Bonus
#define INV_CAPTURE_BONUS						5	// what you get for capture
#define INV_TEAM_BONUS							0	// what your team gets for capture
#define INV_FLAG_BONUS							1	// what you get for picking up enemy flag
#define INV_FIRST_FLAG_BONUS					3	// what you get if it's the 1st time the enemy flag is picking up
#define INV_FRAG_CARRIER_BONUS				3	// what you get for fragging enemy flag carrier
#define INV_FLAG_RETURN_TIME					60000	// milliseconds until auto return (should it return ?)

#define INV_CARRIER_DANGER_PROTECT_BONUS	1	// bonus for fraggin someone who has recently hurt your flag carrier
#define INV_CARRIER_PROTECT_BONUS			0	// bonus for fraggin someone while either you or your target are near your flag carrier
#define INV_FLAG_DEFENSE_BONUS				0	// bonus for fraggin someone while either you or your target are near your flag
