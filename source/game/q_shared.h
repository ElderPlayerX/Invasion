...
#define	INVASION_VERSION	"2.8"
#define	Q3_VERSION			"Invasion b"INVASION_VERSION" - Q3 1.31"
...
#define	BUTTON_ATTACK2			32       //Too: Alternate fire, or special weapon mode (zoom)
#define	BUTTON_RELOAD			64       //Too: Reload

//#define	BUTTON_AFFIRMATIVE	32
//#define	BUTTON_NEGATIVE		64
#define	BUTTON_AFFIRMATIVE	4096
#define	BUTTON_NEGATIVE		8192
...
//=========================================
//Too: Invasion global define here
//=========================================

enum
{
	es_FlameTime			=	750,
	es_FlameBaseRadius	=	8, //16,
	es_FlameMulRadius		=	80, //64,
	es_FlameThrowerTime	=	125,
	es_FlameThrowerTick	=	es_FlameThrowerTime / 3,
	es_FlamePreStep		=	10,
};

//Too: special use of character chain for trap_SendServerCommand()
...
enum
{
	...
	es_InvCS_Health = 8,
	es_InvCS_Armor = 10,
	es_InvRadar_Radius = 8,
	es_InvRadar_Angle = 6,
	es_InvRadar_Height = 2,
	es_InvRadar_Team = 1,
};
...
uchar Inv_AlphaFromNum(int n);	// send a char for 0 <= n < 64
int Inv_NumFromAlpha(uchar c);	// send number for char
