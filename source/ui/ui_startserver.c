...
static const char *gametype_items[] =
{
	...
	"Tournament",
	"Capture the Flag",
	"Invasion b"INVASION_VERSION,
	0
};

static int gametype_remap[] = {GT_FFA, GT_TEAM, GT_TOURNAMENT, GT_CTF, GT_INVASION};
...
static void StartServer_MenuInit(void)
{
	...
	s_startserver.gametype.curvalue		= 4;
...
static void ServerOptions_Start(void)
{
	...
	case GT_INVASION:
		...
		trap_Cvar_SetValue("ui_inv_friendlt", friendlyfire);
...
/*
=================
ServerOptions_StatusBarRoundTime
=================
*/
...
static void ServerOptions_MenuInit(qboolean multiplayer)
{
	...
	y = 272;
	if (s_serveroptions.gametype != GT_CTF && s_serveroptions.gametype != GT_INVASION)
	{
