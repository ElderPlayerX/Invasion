...
//	int				fraglimit;
	...
	str = Info_ValueForKey(levelMenuInfo.selectedArenaInfo, "longname");
	if (!Q_stricmp(str, ""))
		str = Info_ValueForKey(levelMenuInfo.selectedArenaInfo, "map");
	Com_sprintf(string, sizeof(string), "%s: %s", buf, str);
